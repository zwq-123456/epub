    ...
    getSectionName() {
      if (this.section) {
        ...
        if (sectionInfo && sectionInfo.href) {
          //   //   return this.currentBook.rendition.navigation.get(section.href).label;
          //   console.log(this.currentBook.rendition.navigation.get(sectionInfo.href));
        }
      }
      return "";
    },
    ...
    displaySection() {
      ...
      if (sectionInfo && sectionInfo.href) {
        this.currentBook.rendition.display(sectionInfo.href).then(() => {
          const currentLoction = this.currentBook.rendition.currentLocation();
